...
<div class="fullContainer mt-2">
    ...
    <input type="text" v-model="searchString" class="form-control" placeholder="Buscar..." aria-label="Buscar.." aria-describedby="addon-wrapping">
    <button @click="search">
...
<!-- First Row -->
    <!-- Filtered -->
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 posts-container" id="non-filtered" v-if="this.searchEnabled!=true">
    <div  v-for="blog in blogs" :key="blog.id">
     ...
     <!-- Filtered -->
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 posts-container" id="filtered" v-if="this.searchEnabled==true">
